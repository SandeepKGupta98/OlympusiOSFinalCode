...
-(void)getInboxFromServer{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/api/v2/videos?auth_token=5c2b9071-a675-49b0-8fb2-9cd894da1c87&page=%ld",base_url,(long)pageNum];
...
-(void)setVideoWatchImpression:(NSDictionary *)videoDict{
    ...
    NSString *access_token = [userInfo valueForKey:@"access_token"];
    [manager.requestSerializer setValue:[NSString stringWithFormat:@"Bearer %@",access_token] forHTTPHeaderField:@"Authorization"];
    NSString *url = [NSString stringWithFormat:@"%@/api/v2/video/%@/%@?auth_token=5c2b9071-a675-49b0-8fb2-9cd894da1c87",base_url,[videoDict valueForKey:@"id"], [[[UtilsManager sharedObject] getUserDetailsFromDefaultUser] valueForKey:@"id"]];

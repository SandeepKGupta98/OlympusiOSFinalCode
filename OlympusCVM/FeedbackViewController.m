...
-(IBAction)submitButtonTapped:(id)sender{
    ...
    if ([[userData valueForKey:@"is_testing"] boolValue]) {
        apiurl = [NSString stringWithFormat:@"%@/api/v1/service/feedback",[userData valueForKey:@"testing_url"]];
    }else{
        apiurl = [NSString stringWithFormat:@"%@/api/v1/service/feedback",base_url];
    }
